...
//let myGrade: String = grade(of: 87)
//let myPoint: Double = point(of: myGrade)

let myPoint: Double = point(of: grade(of: 97))
...
//leapyearCalculate(input: 1988)
//leapyearCalculate(input: 232)
