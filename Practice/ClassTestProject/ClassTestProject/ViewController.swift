...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let mazingaZ = Student(name: "마징가z", gender: "남", major: "초딩")
        mazingaZ.setSubjects(subjectDic: ["국어":80, "산수":100, "슬기로운생활":50, "기술":10, "싸움":99])
        
        let lazenca = Student(name: "라젠카", gender: "여", major: "고딩")
        lazenca.setSubjects(subjectDic: ["언어":50, "수학":80, "도덕":90, "과학":100, "싸움":87])
        
        let atom = Student(name: "아톰", gender: "남", major: "고딩")
