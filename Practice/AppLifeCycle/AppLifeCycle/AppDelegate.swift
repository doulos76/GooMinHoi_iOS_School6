...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        print("application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool")
        
//        //stroyboard
//        let storyboard = UIStoryboard(name: "NewStoryboard", bundle: nil)
//        let myListVC: NewViewController1 = storyboard.instantiateInitialViewController() as! NewViewController1
//        //VC
//        //single tone
...
//        window?.makeKeyAndVisible()
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        ...
        print("applicationWillEnterForeground(_ application: UIApplication)")
    }
